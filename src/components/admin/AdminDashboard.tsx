  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Bienvenido al panel de control de CortinasAC</p>
      </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-[#E31E24]">{stat.value}</p>
              </div>
            ...
            {empleadosConectados.map((empleado) => (
              <div key={empleado.id} className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className="h-8 w-8 rounded-full bg-[#E31E24] flex items-center justify-center">
